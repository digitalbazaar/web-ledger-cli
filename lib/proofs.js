 ...
 * @param {string} options.capability the ID of the capability that is being
 *                                    invoked.
 * @param {string} options.capabilityAction the capability action being invoked.
 * @param {string} options.creator the ID of the public key proving invocation
 *                                 authorization.
 * @param {string} options.privateKeyBase58 the private key material used to
 *                                          sign the proof.
